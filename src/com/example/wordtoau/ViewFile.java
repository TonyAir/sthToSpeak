...
import com.example.speech.setting.TtsSettings;
import com.example.speech.util.ApkInstaller;
import com.example.voicedemo.TtsDemo;
 ...
 *
 */
public class ViewFile extends Activity implements OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			initLayout();
			// 初始化合成对象
			mTts = SpeechSynthesizer.createSynthesizer(ViewFile.this, mTtsInitListener);
			// 云端发音人名称列表
			mCloudVoicersEntries = getResources().getStringArray(R.array.voicer_cloud_entries);
			mCloudVoicersValue = getResources().getStringArray(R.array.voicer_cloud_values);
			mSharedPreferences = getSharedPreferences(TtsSettings.PREFER_NAME, MODE_PRIVATE);
			mToast = Toast.makeText(this,"",Toast.LENGTH_SHORT);
			mInstaller = new  ApkInstaller(ViewFile.this);
	...
	private void initLayout() {
		findViewById(R.id.tts_play).setOnClickListener(ViewFile.this);
		findViewById(R.id.tts_cancel).setOnClickListener(ViewFile.this);
		findViewById(R.id.tts_pause).setOnClickListener(ViewFile.this);
		findViewById(R.id.tts_resume).setOnClickListener(ViewFile.this);
		findViewById(R.id.image_tts_set).setOnClickListener(ViewFile.this);
		findViewById(R.id.tts_btn_person_select).setOnClickListener(ViewFile.this);		
	...
	public void onClick(View view) {
		...
		case R.id.image_tts_set:
			if(SpeechConstant.TYPE_CLOUD.equals(mEngineType)){
				Intent intent = new Intent(ViewFile.this, TtsSettings.class);
        ...
        // 合成的音频格式：只支持pcm格式
		case R.id.tts_play:
			String text = ((TextView) findViewById(R.id.view_contents)).getText().toString();
			// 设置参数
			setParam();
